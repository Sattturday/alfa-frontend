...
const allIprSlice = createSlice({
  ...
  reducers: {
    setAllIpr(state, action) {
      state.iprCards = action.payload;
    },
  },
});

export const { setAllIpr } = allIprSlice.actions;

export default allIprSlice.reducer;
