    ...
    <section className={styles.root}>
      <div className={styles.infoColumn}>
        ...
        <p className={styles.description}>
          Ты мощь, ты сила, уважаю, ты красавчик. Однажды в студеную зимнюю пору
          я из лесу вышел, был сильный мороз.Ты мощь, ты сила, уважаю, ты
          красавчик. Однажды в студеную зимнюю пору я из лесу вышел, был сильный
          мороз.
        </p>
